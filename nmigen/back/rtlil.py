...
class _RHSValueCompiler(_ValueCompiler):
    ...
    def on_Operator_unary(self, value):
        ...
        if arg_bits >= 1e6:
            warnings.warn("Very wide input wire was generated by '%s' operation (%d bits wide)"%(value.operator, arg_bits))
        return res
    ...
    def on_Operator_binary(self, value):
        ...
        if res_bits >= 1e6:
            warnings.warn("Very wide output wire was generated by '%s' operation (%d bits wide)"%(value.operator, res_bits))
        if lhs_bits >= 1e6:
            warnings.warn("Very wide input lhs wire was generated by '%s' operation (%d bits wide)"%(value.operator, lhs_bits))
        if rhs_bits >= 1e6:
            warnings.warn("Very wide input rhs wire was generated by '%s' operation (%d bits wide)"%(value.operator, rhs_bits))
        return res
